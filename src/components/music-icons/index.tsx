...
export default function MusicIcons() {
    const leftMusic = [
        {id : 1,src : Music1, width : 30, top : 0, left : 5},
        {id : 2,src : Music2, width : 50, top : 22, left : 12},
        {id : 3, src : Music3, width : 55, top : 34, left : 0},
        {id : 4, src : Music4, width : 90, top : 45, left : 8},
    ]
    const rightMusic = [
        {id : 5,src : Music5, width : 83, top : 0, right : 4},
        {id : 6,src : Music6, width : 70, top : 42, right : 10},
    ]
    return (
        <S.MusicIcons>
            <S.Section>
